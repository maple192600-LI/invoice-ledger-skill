...
class InvoiceItem(ContractModel):
    ...
    toll_variant: str | None = None
    vehicle_plate_no: str | None = None
    toll_entrance: str | None = None
    toll_exit: str | None = None
    passage_time: str | None = None
    discount_for_line_no: int | None = None
...
class InvoiceQuality(ContractModel):
    ...
    # 数据来源：recognition=版面识别(文本层/OCR)；structured=结构化直读(内嵌XBRL/总局XML)
    data_source: str = "recognition"
