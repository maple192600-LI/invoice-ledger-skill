...
class TollPlateMiddleDotTest(unittest.TestCase):
    ...
    def test_plate_with_middle_dot_and_entrance_are_captured(self) -> None:
        ...
        self.assertEqual(item["vehicle_plate_no"], "晋A·T0000")
        self.assertEqual(item["toll_entrance"], "甲收费站")
        self.assertEqual(item["toll_exit"], "乙收费站")
